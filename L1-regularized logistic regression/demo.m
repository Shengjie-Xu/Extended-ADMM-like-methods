...
[x history] = logreg(A, b, mu, 1.0);        % the original ADMM
[x history] = logreg_pd_pc(A, b, mu, 1.0);  % the primal-dual extended ADMM
[x history] = logreg_dp_pc(A, b, mu, 1.0);  % the dual-primal extended ADMM