...
[x history] = linear_svm(A, lambda, p, 1.0);       % the original ADMM
[x history] = linear_svm_pd_pc(A, lambda, p, 1.0); % the primal-dual extended ADMM
[x history] = linear_svm_dp_pc(A, lambda, p, 1.0); % the dual-primal extended ADMM
